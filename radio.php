...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style-radio.css">
...
<body>
		...
		<section class="videos">
			<div class="container">
				<div class="container-hender">
					<div class="row">
						<div class="col-sm-12">
							<div class="line-titulo"><h1 alt="radio ao vivo agora">Ao vivo agora</h1></div><!--line-titulo-->
			...
			<div class="container">
				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-md-2">
								<img src="https://image.ibb.co/jw55Ex/def_face.jpg" alt="Comentário de Aberta Demais De Oliveira" class="img img-rounded img-fluid w50"/>
								<p class="text-secondary text-center">15 Minutes Ago</p>
							</div><!--col-md-2-->
							<div class="col-md-10">
								<p>
	...
	<hr class="featurette-divider"><!--featurette-divide-->
