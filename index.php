	  		...
	  		<div class="container marketing">
	  			...
	  			<div class="row locutores">
	  				<div class="col-lg-4 img" id="locutores">
	  					<img class="d-block bd-placeholder-img rounded-circle mx-auto" src="images/wendell.jpg" alt="Wendell Bezerra">
	  				...
	  				<div class="col-lg-4 img">
	  					<img class="d-block bd-placeholder-img rounded-circle mx-auto" src="images/marcio.jpg" style="border-radius: 200px;" alt="Marcio Seixas">
	  					<h2>Marcio Seixas</h2>
	  				...
	  				<div class="col-lg-4 img">
	  					<img class="d-block bd-placeholder-img rounded-circle mx-auto" src="images/marco.jpg" style="border-radius: 200px;" alt="Marco Ribeiro"> 
	  					<h2>Marco Ribeiro</h2>
