...
<head>
	...
	<link type="text/css" rel="shortcut icon" href="http://www.radiojuazeiro.com.br/favicon.ico">
	<link rel="stylesheet" type="text/css" href="css/style-contato.css">
	<link rel="stylesheet" type="text/css" href="css/style.css">
	<link type="text/css" rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.2/css/bootstrapValidator.min.css"/>
	...
	<section>
		<div class="atalhos">
			<ul>
				...
				<li><a href="#venha_visitar" accesskey="2">Ir para menu noticias[2]</a></li>
			</ul>
		</div>
	</section>
	<!---->
